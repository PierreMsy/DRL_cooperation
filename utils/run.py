...
class Runner:
            ...
            for episode in range(1, nb_episodes+1):
                ...
                while True:
                    ...
                    if np.any(dones):
                        ...
                        if (episode % 1000 == 0) & hasattr(MA_agents, 'agents'):
                            if (hasattr(MA_agents.agents[0].noise, 'sigma_init') & 
                                    (MA_agents.agents[0].noise.sigma != MA_agents.agents[0].noise.sigma_init)):
    ...
    def run_state(self, MA_agents, env, brain_name, nb_episodes, run_key,
            average_on=10, target_score=None, target_over=100,
            save_score=True, save_config=True, save_weights=False, save_interaction=False):
            ...
            for episode in range(1, nb_episodes+1):
                ...
                while True:
                    ...
                    if np.any(dones):
                        ...
                        MA_agents.update(score_by_agent)
